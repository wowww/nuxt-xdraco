  ...
  &__inner {
    ...
    > strong {
      ...
      &::before {
        ...
        width: 16px;
        height: 16px;
        background: url('https://file.mir4global.com/xdraco/img/common/currency-notice2/ico-exclaim.webp') 0 0 / cover no-repeat;
      }
    }
    ...
    > p {
      ...
      &::before {
        ...
        width: 56px;
        height: 56px;
        background: url('https://file.mir4global.com/xdraco/img/common/currency-notice2/img-exd-symbol.webp') 0 0 / cover no-repeat;
      }
